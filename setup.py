# Moyai a Discord bot (Python 3.10)
...
def main():
	...
	print("\n========================================")
	print("Moyai" + ver + " setup application")
	print("Github Link for Moyai here")
	print("========================================")
	print("\nWelcome to the Moyai setup! Make sure you have read the README carefully, so you know what you're doing.\nRemember, you will have to manually edit the 'config.py' file to change the bot's prefix and description.\n")
	...
	try:
		config_lines[3] = 'bbtoken = "' + tokenset + '" # REMOVE TOKEN BEFORE SYNC!! -Moyai' + '\n'
		config_lines[4] = '\n'
		config_lines[5] = '# YouTube API key (https://console.developers.google.com/apis/credentials/key)' + '\n'
		config_lines[6] = 'key = "' + keyset + '" # REMOVE KEY BEFORE SYNC!! -Moyai' + '\n'
